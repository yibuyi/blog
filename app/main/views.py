...
from flask import url_for, render_template, flash, request, current_app, make_response
...
@main.route('/', methods=['GET', 'POST'])  # 处理博客文章的首页路由
def index():
	form = PostForm()
...
@main.route('/edit-profile', methods=['GET', 'POST'])  # 用户的资料编辑路由
@login_required
def edit_profile():
